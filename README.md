...
### my deployed netlify: 
https://alaa-abuissa-portfolio.netlify.app/


##  Feature Number : 1 
### name of feature: create a unique portfolio online
...
##  Feature Number : 2
### name of feature: create a Profile Page

Estimate of time needed to complete: 10 min

Start time: 10.40  pm 

Finish time: 10.55 pm

Actual time needed to complete: 15 min 


##  Feature Number : 3
### name of feature: create  Nav, Header and Footer
...
##  Feature Number : 4
### name of feature: create  Portfolio Page
